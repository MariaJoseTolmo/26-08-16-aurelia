import { RecordStatus, CreateBusinessUnitRequest, OrganizationConstraints } from '@aurelia/contracts';
import { IsEnum, IsOptional, IsString, MaxLength, MinLength } from 'class-validator';

export class CreateBusinessUnitDto implements CreateBusinessUnitRequest {
  @IsString()
