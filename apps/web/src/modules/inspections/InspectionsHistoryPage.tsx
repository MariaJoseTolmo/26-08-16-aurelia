    ...
    <div className="bg-white h-[56px] relative shrink-0 w-full" data-name="Header">
      ...
      <div className="content-stretch flex items-center pb-px px-[24px] relative size-full">
        <div className="flex flex-col items-start">
          ...
          <p className="font-['Inter:Regular',sans-serif] text-[#646464] text-[12px] font-normal leading-[normal] whitespace-nowrap">Inspecciones cerradas · ordenadas por fecha de cierre</p>
        </div>
      </div>
    </div>
  );
...
export function InspectionsHistoryPage() {
  return (
    <div className="relative h-screen w-full overflow-hidden" data-name="Historial de inspecciones">
      <AppSidebar />
      <DashboardFrameShell
