...
// Caret del selector "Filas por página". Figma node 3734:28540. Fill original: #131313.
export function WarehouseRowsPerPageCaretIcon(props: IconProps) {
  return (
    <svg width="11.25" height="9" viewBox="0 0 11.25 9" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
      <path d="M5.22905 7.14761C5.44878 7.36733 5.80562 7.36733 6.02534 7.14761L9.40034 3.77261C9.62007 3.55288 9.62007 3.19604 9.40034 2.97632C9.18062 2.75659 8.82378 2.75659 8.60405 2.97632L5.62632 5.95405L2.64858 2.97808C2.42886 2.75835 2.07202 2.75835 1.85229 2.97808C1.63257 3.1978 1.63257 3.55464 1.85229 3.77437L5.22729 7.14937L5.22905 7.14761Z" fill="currentColor" />
    </svg>
  );
}
